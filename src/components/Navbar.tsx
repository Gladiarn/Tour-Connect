            ...
            <Popover>
              <PopoverTrigger asChild>
                <div className="flex-grow focus:outline-0 cursor-pointer flex items-center justify-between">
                  <p className="flex text-[#3C3D37] cursor-pointer">{language}</p>
                </div>
              </PopoverTrigger>
              <PopoverContent
                align="start"
              ...
              >
                <div className="flex flex-col gap-1">
                  <p className="cursor-pointer hover:text-blue-500" onClick={() => setLanguage("Filipino")}>
                    🇵🇭 Filipino
                  </p>
                  <p className=" cursor-pointer hover:text-blue-500"  onClick={() => setLanguage("English")}>
                    🇺🇸 English
                  </p>
                </div>
              </PopoverContent>
