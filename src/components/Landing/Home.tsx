...
export default function Landing() {
  ...
  return (
    <div className="relative w-full min-h-[700px] overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col px-[30px] lg:px-[100px] font-poppins">
        <div
          className="
            flex flex-col gap-[20px] 
            backdrop-blur-[5px] border border-white 
            px-[25px] py-[25px] h-fit max-w-[509px] 
            rounded-[15px] mt-60
          "
        >
          <div className="flex flex-col w-full h-fit">
            <p className="text-[15px] lg:text-[20px] w-full h-fit text-white font-medium">
              Welcome to TourConnect
            </p>
            <p className="text-[35px] lg:text-[50px] w-full h-fit text-white font-bold">
              Explore Visayas
            </p>
            <p className="text-[13px] lg:text-[15px] w-full h-fit text-white font-medium">
          ...
          <div className="flex w-full items-center gap-[25px] justify-end h-fit text-white">
            <div className="flex border-b border-white w-fit h-fit font-bold whitespace-nowrap">
              <a href="#">Learn More</a>
            </div>
            <div className="flex h-fit w-fit items-center">
              <button
                ...
                px-[20px] py-[5px] rounded-[10px] text-[17px] whitespace-nowrap
              "
              >
                Sign-Up
              </button>
