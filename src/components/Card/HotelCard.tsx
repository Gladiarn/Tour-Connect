    ...
    >
      ...
      <div className="p-[10px] text-[#3C3D37] flex flex-col gap-5">
        ...
        <div className="flex justify-between">
          ...
          <button className="px-4 py-2 text-white border border-white rounded-sm bg-[#3C3D37] hover:bg-white hover:text-[#3C3D37] hover:border-[#3C3D37] cursor-pointer transition-colors ease-in-out duration-200">
            View More
          </button>
        </div>
      </div>
