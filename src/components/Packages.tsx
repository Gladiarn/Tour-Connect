...
export default function Packages() {
  return (
    <div className="flex flex-col w-full h-fit bg-white">
      ...
      >
        <p className="flex font-bold text-[64px] text-white">Discover Adventure Packages</p>
        <p className="flex font-normal text-[26px] text-white">Curated experiences across the breathtaking spots of Eastern Visayas</p>
